...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { att: @monster.att, hp: @monster.hp, name: @monster.name } }, as: :json
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { att: @monster.att, hp: @monster.hp, name: @monster.name } }, as: :json
    assert_response 200
  end
